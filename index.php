...
<div class="container"> 
    ...
    <hr>
    <div class="content">
        <!-- <div class="badge-span"><h4><a href="/all_shoes.php"><span class="badge badge-light">Новая обувь</span></a></h4></div> -->
        ...
        <?php array_multisort(array_column($spring_shoes, "created_at"), SORT_DESC, $spring_shoes); ?>
        <?php $i = 0;
        ...
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel">
                <div class="carousel-item active shoe_post_index">
                    ...
                    <a href="single_post.php?modelname=<?php echo $spring_shoe['modelname']; ?>">
                        <div class="shoe_info">
        ...
        <?php array_multisort(array_column($autumn_shoes, "created_at"), SORT_DESC, $autumn_shoes); ?>
        <?php $i = 0;
        ...
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel">
                <div class="carousel-item active shoe_post_index">
                    ...
                    <a href="single_post.php?modelname=<?php echo $autumn_shoe['modelname']; ?>">
                        <div class="shoe_info">
